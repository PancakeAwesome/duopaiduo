...
function save(){
	...
	var package_ids=s.substring(0,s.Length-1);//规格
//	var payment='';//付款方式
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                    <input type="hidden" value="${gd.goodsId }" />
                                    <input type="text" class="form-control f_l" value="${gd.goodsName }" id="goods_name" placeholder="请输入商品名称"></td>
                                </tr>
                                <tr>
                                    <td>商品封面图:</td>
                                    <td>
                                        <div class="file clearfix">
                                            <div>
                                                <img src="/dobado_info/${gd.imgUri }" alt="" id="img_uris">
                                            </div>
                                            <label class="f_l">
                                                <input id="imgfile" type="file" name="imgfile" value="" onchange="btnUpload('imgfile','img_uri')" placeholder="">+
                                            </label>
                                            <input type="hidden"  style="display: none;" id="img_uri" value="${gd.imgUri }" name="img_uri" >
                                ...
                                <tr>
                                    <td>商品价格:</td>
                                    <td><input type="text" class="form-control f_l" value="${gd.price }" id="price" placeholder="请填写商品价格"></td>
                                </tr>
                                <tr>
                                    <td>原价:</td>
                                    <td><input type="text" class="form-control f_l" value="${gd.orprice }" id="orprice" placeholder="请填写原价"></td>
                                </tr>
                                <tr>
                                    <td>折扣:</td>
                                    <td><input type="text" class="form-control f_l" value="${gd.discount }" id="discount" placeholder="请填写折扣"></td>
                                </tr>
                                <tr>
                                    <td>节省:</td>
                                    <td><input type="text" class="form-control f_l" value="${gd.save }" id="save" placeholder="请填写节省"></td>
                                </tr>
                                <tr>
                                    <td>已购人数:</td>
                                    <td><input type="text" class="form-control f_l" value="${gd.number }" id="number" placeholder="请输入购买基数"></td>
                                </tr>
                                <tr>
                                    <td>剩余时间:</td>
                                    <td><input type="text" class="form-control f_l" value="${gd.residualTime }" id="residual_time" placeholder="请填写剩余时间"></td>
                                </tr>
                                <tr>
                                    <td>抢购描述:</td>
                                    <td><textarea class="form-control" rows="5" name="" id="describe" placeholder="请输入抢购描述" >${gd.describe }</textarea></td>
                                </tr>
                                <tr>
                                    <td>购买流程:</td>
                                    <td>
                                        <div class="file clearfix">
                                            <div>
                                                <img src="/dobado_info/${gd.purchaseUri }" alt="" id="purchase_uris" >
                                            </div>
                                            <label class="f_l">
                                            ...
                                            <input type="hidden" style="display: none;" value="${gd.purchaseUri }" id="purchase_uri" name="purchase_uri" >
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="file clearfix" id="introduce_uri">
                                            <div id="file_imgs">${gd.introduceUri }
                                            </div>
                                            <label class="f_l">
                                ...
                                <tr>
                                    <td>客户服务:</td>
                                    <td><textarea id="customer" class="form-control" rows="5" name="" placeholder="请输入客户服务" >${gd.customer }</textarea></td>
                                </tr>
                                <tr>
                                    <td>商品规格:</td>
                                    <td align="left ">
                                    ...
                                    <input type="hidden" value="${gd.packageIds }" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <div id="peizhi" class="comment_content" style=" width: 500px;">
                                                            	<div>产品不错，值得购买  <i  onclick="shancu(this)" class="f_r  icon-remove"></i></div>
                                                            </div>
                                                            <button id="tianjia" class="btn">添加</button>
                                                        </td>
                                                    </tr>
...
$('.table').find('#tianjia').click(function(){
    ...
    layer.prompt({title:'test'},function(val){
        aaa.prev().append('<div>'+val+'<i onclick="shancu(this)" class="f_r icon-remove"></i>');
        layer.closeAll();
    });
})
...
function aaa(a){
	if(a=='files_img'){
		...
		htm +='<img src="/dobado_info/'+$("#"+a).val()+'" alt="">'
		$("#file_imgs").html(htm);
	}else{
		 $('#'+a+'s').attr('src',"/dobado_info/"+$("#"+a).val()).show();

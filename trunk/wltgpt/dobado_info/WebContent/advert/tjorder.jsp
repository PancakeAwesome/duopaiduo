		...
		$.ajax({
			...
			success : function(data) {
				...
				$.each(data.list,function(i,obj){
					htm +='<tr>';
					htm +='<td><input type="checkbox" name="" value=""></td>';
					htm +='<td>'+obj.goods_name+'</td>';
					htm +='<td>'+obj.price+'</td>';
					htm +='<td>'+obj.package_number+'</td>';
					htm +='<td>'+obj.zchannel_name+'</td>';
					htm +='<td>'+(obj.addTime).substr(0,10)+'</td>';
					htm +='</tr>';
				});
				$("#tablehtm").html(htm);
				laypage({
        ...
        <div class="wrap clearfix">
            <div class="wrap_l">
                ...
                <ul class="">
                    ...
                    <li><a class="current" href="">订单统计</a></li>
            ...
            <div class="wrap_r">
                ...
                <div class="goods">
                    ...
                    <form id="frm" action="toExcel" method="post">

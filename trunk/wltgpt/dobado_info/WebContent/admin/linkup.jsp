                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <td width="20%">链接名称：</td>
                                <td>
                                <input type="hidden" id="navigation_id" value="${link.navigationId }" />
                                <input type="text" class="form-control f_l" id="navigation_name" value="${link.navigationName }" placeholder=""></td>
                            </tr>
                            <tr>
                                <td>链接地址：</td>
                                <td><input type="text" class="form-control f_l" id="navigation_url" value="${link.navigationUrl }" placeholder=""></td>
                            </tr>
                            <tr>
                                <td>是否显示：</td>
                                <td>
                                	<input type="hidden" id="isShows" value="${link.status }"/>

		 ...
		 $.ajax({
				...
				success : function(data) {
					...
					$.each(datas.list,function(i,obj){
						...
						neirhtm +='<td><img src="/'+obj.uri+'" width="100px" height="100px" alt=""></td>';
						...
						if(obj.status==2)
							neirhtm +='<td>未通过</td>';
						neirhtm +='<td>';
							 neirhtm +='<a href="adupsel?adId='+obj.id+'" ><button type="submit" class="btn btn-default ">修改</button></a>';
							 neirhtm +='<button onclick="deleteid('+obj.id+')" type="button" class="btn btn-default ma_l20">删除</button>';
						neirhtm +='</td>';
						neirhtm +='<tr>';
					});
...
<!--wrap-->
    <div class="wrap_bg thewidth100">    
        <div class="wrap clearfix bghui">
            ...
            <h2>广告管理</h2>
                <ul>
                    <li><a href="advert.jsp" class="choice">广告列表</a></li>
                    ...
                    <table  class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>
                                	<select id="isShow" onchange="erjigaibian(1)" >

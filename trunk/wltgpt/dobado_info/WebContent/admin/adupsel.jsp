...
<script type="text/javascript">
	...
	function save(){
		...
		var isShow=$('input[name=isShows]:checked').val();
		var param ={
				"menu.id" : $("#adId").val(),
                    ...
                    <form>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td>广告标题:</td>
                                    <td><input type="text" class="form-control f_l" id="title" value="${ad.title }" placeholder="请填写广告标题"></td>
                                </tr>
                                <tr>
                                    <td>广告分类:</td>
                                    <td align="left">
                                ...
                                <tr>
                                    <td>广告链接：</td>
                                    <td><input type="text" class="form-control f_l" id="url" value="${ad.url }" placeholder=""></td>
                                </tr>
                                <tr>
                                    <td>上传图片：</td>
                                    <td>
                                    	<div class="clearfix">
											...
											<input type="text" value="${ad.uri }" style="display: none;" id="imgUri" name="img_uri" ">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label class="f_l"><input type="radio" name="isShows" value="1" />显示</label>
                                        <label class="ma_l20 f_l"><input type="radio" name="isShows" value="0" checked/>隐藏</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>排序：</td>
                                    <td><input type="text" class="form-control f_l" id="sort" value="${ad.sort }" placeholder=""></td>
                                </tr>
                                <tr>
                                    <td>开始时间：</td>
                                    <td>
                                        <div class="form-group f_l sj">
                                            <input id="start_time" value="${ad.startTime }"style="left: 0px; top: -2px; border: 1px solid rgb(204, 204, 204);" type="text" class="form-control laydate-icon" placeholder="开始时间">
                                        </div>
                                       <!-- 
                                       <div class="form-group f_l sj">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group f_l sj">
                                            <input id="end_time" value="${ad.endTime }"style="left: 0px; top: -2px; border: 1px solid rgb(204, 204, 204);" type="text" class="form-control laydate-icon " placeholder="结束时间">
                                        </div>
                                    </td>
                                </tr>
                               <!--  <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" onclick="empty()" class="btn btn-default ma_l20 f_l">重置</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>

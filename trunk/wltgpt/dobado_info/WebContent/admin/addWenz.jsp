        ...
        <div class="wrap clearfix bghui">
            ...
            <h2>添加文章</h2>
            	<ul>
                    ...
                    <li><a href=""  class="choice">添加资讯文章</a></li>
                ...
                <div class="modify">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td>文章标题：</td>
                                <td><input type="text" style="width: 300px" class="form-control f_l wn250" id="titles" placeholder="请填写文章标题"></td>
                                <td>排序：</td>
                                <td><input type="text" class="form-control f_l wn250" id="sort" placeholder=""></td>
                            
                            </tr>
                            <tr>
                                <td>文章来源</td>
                                <td><input type="text" class="form-control f_l wn250" id="source" placeholder=""></td>
                                <td>作者：</td>
                                <td><input type="text" class="form-control f_l wn250" id="source_value" placeholder=""></td>
                            </tr>
                            <tr>
                                <td>责任编辑</td>
                                <td><input type="text" class="form-control f_l wn250" id="respon" placeholder=""></td>
                                <td>标签：</td>
                                <td><input type="text" class="form-control f_l wn250" id="seo_key" placeholder=""></td>
                            </tr>
                            <tr>
                                <td>上传图片</td>
                                <td colspan="3">
								    ...
								    <img alt="" src="" style="display: none; float:left; height:100px; width: 100px;" id="showImg" >
					    		</td>
                            </tr>
                            <tr>
                                <td>摘要</td>
                                <td colspan="3">
                                	<textarea style="width:740px;" class="f_l" id="content_summarys" rows="" cols=""></textarea>
					    		</td>
                            </tr>
                            <tr>
                                <td>文章内容</td>

	...
	$.ajax({
		...
		success : function(data) {
			...
			$.each(data.paihang,function(i,obj){
                ...
                paihangbang +='<h4 class="img"><a href="article?articleid='+obj.article_id+'" target="view_window">'+obj.title+'</a></h4>';
            ...
            $.each(data.xinwen,function(i,obj){
                ...
                xinwen +='<h4 class="img"><a href="article?articleid='+obj.article_id+'" target="view_window">'+obj.title+'</a></h4>';
	...
	$.ajax({
		...
		success : function(data) {
			...
			$.each(data.list,function(i,obj){
                ...
                boodhtm +='<a href="article?articleid='+obj.article_id+'" target="view_window">';
				boodhtm +='<h4 class="img">'+obj.title+'</h4>';
                boodhtm +='</a>';

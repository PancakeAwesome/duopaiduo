...
<body style="margin: 1px">
 <table id="dg" title="播客广告管理" class="easyui-datagrid"
   ...
   url="/admin/bokeData?tpId=1" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		<th field="cb" checkbox="true" align="center"></th>
   		<th field="screenId" width="50" align="center">编号</th>
   		<th field="imgText" width="100" align="center">标题</th>
   		<th field="screenActionUrl" width="100" align="center">视频链接地址</th>
   	...
   	<table cellspacing="8px">
   		...
   		<tr>
   			...
   			<td>
						...
						<input type="text" style="display: none;" id="screenImgUrl" name="screenImgUrl" onchange="aaa(this)">

...
//删除
 function deleteDataDic(){
	 ...
	 $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
		if(r){
			$.post("/admin/adDelete",{ids:ids},function(result){
				if(result > 0){
 ...
 function openDataDicModifyDialog(){
	 ...
	 $("#fm").form("load",row);
	 url="/admin/adUpdate?menu.id="+row.id;
 }
...
<body style="margin: 1px">
 <table id="dg" title="广告管理" class="easyui-datagrid"
   fitColumns="true" pagination="true" rownumbers="true"
   url="/admin/adData" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		<th field="cb" checkbox="true" align="center"></th>
   		<th field="id" width="50" align="center">编号</th>
   		<th field="title" width="100" align="center">标题</th>
   		<th field="url" width="100" align="center">广告链接地址</th>
   		<th field="uri">" width="100" align="center">图片地址</th>
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		 <tr>
   			<td>分类：</td>
   			<td>
	   			<select name="banner_id" id="banner_id" style="width: 200px" class="yijifl">
	 			</select> 
 			</td>
   		 ...
   		 <tr>
   			<td>标题：</td>
   			<td>
   				<input type="text" id="title" name="title" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font>
 			</td>
   		...
   		<tr>
   			<td>链接地址：</td>
   			<td>
   			<input type="text" id="url" name="url" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font>
   			</td>

...
data.total=parseInt(JSON.parse(data.data).data.total);
_51d.data=data;
if(data.footer){
...
function _520(){
if(opts.idField){
for(var i=0;i<JSON.parse(data.data).data.rows.length;i++){
var row=JSON.parse(data.data).data.rows[i];
...
var rows=JSON.parse(_549.data.data).data.rows;
...
var rows=JSON.parse(_54f.data.data).data.rows;
...
if(ck.length==JSON.parse(_556.data.data).data.rows.length){
var dc=_556.dc;
...
var rows=JSON.parse(_55f.data.data).data.rows;
...
var rows=JSON.parse(_562.data.data).data.rows;
...
var data=_59e.data;
var rows=JSON.parse(data.data).data.rows;
var _59f=[];
for(var i=0;i<rows.length;i++){
...
var rows=JSON.parse(_632.data.data).data.rows;
...
return JSON.parse($.data(_66f,"datagrid").data.data).data.rows[parseInt(_670)];
